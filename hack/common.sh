...
DEFAULT_MUST_GATHER_FULL_IMAGE_NAME="${IMAGE_REGISTRY}/${REGISTRY_NAMESPACE}/${MUST_GATHER_IMAGE_NAME}:${IMAGE_TAG}"
...
MUST_GATHER_FULL_IMAGE_NAME="${MUST_GATHER_FULL_IMAGE_NAME:-${DEFAULT_MUST_GATHER_FULL_IMAGE_NAME}}"

DEFAULT_NOOBAA_BUNDLE_REGISTRY="quay.io/noobaa"
DEFAULT_NOOBAA_BUNDLE_NAME="noobaa-operator-bundle"
DEFAULT_NOOBAA_BUNDLE_TAG="v5.9.0"
...
PROVIDER_PROTO="services/provider/proto"
PROVIDER_PB="services/provider/pb"
